# nyc_taxi — Practice exercise solution: Debug a broken ref()

> **You are on `exercise-debug-ref-solution`.** This is the reference solution for the `exercise-debug-ref` drill. Compare your attempt with `git diff exercise-debug-ref exercise-debug-ref-solution`.
