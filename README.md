# nyc_taxi — Practice exercise: Propagate a column change

> **You are on `exercise-column-propagation`.** This is a Week 10 practice drill built on the finished project. Read [`EXERCISE.md`](EXERCISE.md) for the task, do the work, then compare with `git diff exercise-column-propagation exercise-column-propagation-solution`.
