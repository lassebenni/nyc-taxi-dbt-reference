# nyc_taxi — Practice exercise: Debug a broken ref()

> **You are on `exercise-debug-ref`.** This is a Week 10 practice drill built on the finished project. Read [`EXERCISE.md`](EXERCISE.md) for the task, do the work, then compare with `git diff exercise-debug-ref exercise-debug-ref-solution`.
