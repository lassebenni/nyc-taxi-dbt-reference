# nyc_taxi — Practice exercise: Add the four generic tests

> **You are on `exercise-generic-tests`.** This is a Week 10 practice drill built on the finished project. Read [`EXERCISE.md`](EXERCISE.md) for the task, do the work, then compare with `git diff exercise-generic-tests exercise-generic-tests-solution`.
