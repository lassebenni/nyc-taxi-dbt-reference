...
You can use **this reference project** (already ported) or your own Week 10 port. If your port is broken, `git switch ch13-databricks` in this repo gives you a known-good starting point.
...
See `exercise-incremental-timing-solution` for a sample `WRITEUP.md`. Your timings will differ by warehouse size and cluster load — the explanation matters more than the exact seconds.
